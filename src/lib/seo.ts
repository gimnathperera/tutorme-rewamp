...
export const seoPages = {
  home: {
    path: "/",
    title: "Find Home Tutors in Sri Lanka | TuitionLanka",
    description:
      "TuitionLanka matches parents with verified home tutors across Sri Lanka. One-to-one and small group classes for all subjects and grades.",
  },
  registerTutor: {
    path: "/register-tutor",
    title: "Register as a Home Tutor in Sri Lanka | TuitionLanka",
    description:
  ...
  testPapers: {
    ...
    title: "Free O Level and A Level Past Exam Papers | TuitionLanka",
    description:
  ...
  gradesAndSubjects: {
    ...
    title: "O Level and A Level Tuition Subjects | TuitionLanka",
    description:
  ...
  tuitionRates: {
    path: "/tuition-rates",
    title: "Home Tuition Rates in Sri Lanka | TuitionLanka",
    description:
  ...
  faq: {
    path: "/faq",
    title: "Home Tuition FAQ | Tutor Matching | TuitionLanka",
    description:
  ...
  blogs: {
    path: "/blogs",
    title: "Study Tips and Exam Guides | TuitionLanka Blog",
    description:
  ...
  contactUs: {
    path: "/contact-us",
    title: "Contact Us | Home Tutor Support in Sri Lanka | TuitionLanka",
    description:
  ...
  levelAndExams: {
    ...
    title: "Levels and Exams Tuition in Sri Lanka | TuitionLanka",
    description:
  ...
  tuitionAssignments: {
    ...
    title: "Home Tuition Assignments in Sri Lanka | TuitionLanka",
    description:
  ...
  profile: {
    path: "/profile",
    title: "Manage Your TuitionLanka Tutor Profile Settings Securely",
    description:
      "Manage your TuitionLanka tutor profile, contact details, teaching preferences, languages, availability, rates, and secure account settings.",
    noIndex: true,
  },
  resetPassword: {
    path: "/reset-password",
    title: "Reset Your TuitionLanka Account Password Securely",
    description:
      "Reset your TuitionLanka account password securely and regain access to your tutor, parent, or admin account with protected account recovery.",
    noIndex: true,
  },
};
