...
export default function ViewBlogPage() {
  ...
  const paragraph = blog.content.find((c) => c.type === "paragraph") as
    | { type: "paragraph"; text: string }
    | undefined;
  const heading = blog.content.find((c) => c.type === "heading") as
    | { type: "heading"; text: string; level: number }
    | undefined;
  const image = blog.content.find((c) => c.type === "image") as
