  ...
  return (
    <div className="p-4 mb-4 bg-white rounded-3xl 2xl:col-span-2 sm:p-6">
      <div className="flow-root">
        ...
        <div>
          <button className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-semibold rounded-lg text-base px-5 py-2.5 text-center">
            Save all
          </button>
        </div>
      </div>
