...
const ProfilePage: FC = () => {
  const {
    ...
    forms: { generalInfoForm, educationInfoForm, languageAndTimeForm, teachingProfileForm },
    handlers: {
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-4 sm:px-6 lg:px-8 sm:py-6">
        <div className="mb-5 text-left sm:mb-6">
          ...
          <p className="mt-2 max-w-3xl text-sm text-gray-600 sm:text-base">
            Manage your tutor profile by section so it is easier to update your
            personal details, qualifications, availability, and security
            settings.
          </p>
        </div>
        ...
        <Tabs defaultValue="profile" className="space-y-4 sm:space-y-6">
          ...
          <TabsContent value="languages" className="mt-0 space-y-4 sm:space-y-6">
            <FormLanguageTime
          ...
          <TabsContent value="teaching" className="mt-0 space-y-4 sm:space-y-6">
            <FormTeachingProfile
          ...
          <TabsContent value="security" className="mt-0 space-y-4 sm:space-y-6">
            <FormPasswordInfo />
          </TabsContent>
        </Tabs>
      </div>
