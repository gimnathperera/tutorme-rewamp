...
const OurTeam = () => {
  return (
    <div className="mx-auto max-w-7xl py-8 lg:py-12 px-4 lg:px-8">
      ...
      <p className="text-base font-normal text-center text-[#4B5563] pt-5 max-w-3xl mx-auto leading-relaxed animate-on-scroll stagger-1">
