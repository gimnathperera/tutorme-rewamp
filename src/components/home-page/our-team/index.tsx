        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-base font-normal text-[#4B5563] pt-5 leading-relaxed animate-on-scroll stagger-1">
              We&apos;re dedicated to helping students and tutors connect through a safe, trusted,
              easy-to-use platform. Every learner deserves quality education in the comfort of their own home - 
              and every tutor deserves recognition for their effort.
            </p>
          </div>
