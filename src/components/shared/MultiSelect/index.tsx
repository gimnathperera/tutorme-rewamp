            ...
            <div className="flex flex-wrap flex-auto gap-2 pr-5">
              {selectedValuesText.length > 0 ? (
                ...
                <input
                  ...
                  className="w-full h-full hover p-1 pr-2 cursor-pointer text-sm bg-transparent border-0 outline-none appearance-none placeholder:text-gray-800 focus:outline-none focus:ring-0 focus:border-0 dark:placeholder:text-white/90"
                  readOnly
                  value="Select option"
                />
              )}
