            ...
            <>
              <div className="relative">
                <input
                  ...
                  className={`relative block w-full appearance-none rounded-md border px-3 py-[0.625rem] text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm ${error ? "border-red-500" : "border-gray-300"
                    } ${className}`}
                  {...props}
                />
                <button
              ...
              {/* Reserved space → no layout jump (matches InputText) */}
