      ...
      <div className="mx-auto max-w-7xl sm:py-20 lg:px-8 my-16">
        ...
        <div className="md:flex md:justify-around mt-20">
          <div className="flex gap-5 justify-center md:justify-start">
            <Image src={RightSvg} alt="right-icon" width={21} height={14} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-16 mx-5 gap-14 manage">
          {filteredData.map((items, i) => (
            <div className="manageTabs text-center p-10" key={i}>
              ...
              <button className="text-sm font-bold text-blue bg-transparent hover:bg-primary-700 hover:text-white border-2 border-blue rounded-full py-4 px-12 mb-6">
                {items.button}
              </button>
